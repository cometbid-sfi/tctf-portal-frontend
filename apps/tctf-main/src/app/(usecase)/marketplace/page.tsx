...
import MarketPlaceLogoSvg from "../../../assets/Images/logo.svg";

const AltArrow: StaticImageData = AltArrowSvg as unknown as StaticImageData;
const MarketPlaceLogo: StaticImageData = MarketPlaceLogoSvg as unknown as StaticImageData;

            ...
            <div className="col-lg-12">
              <div className="hero-content text-center">
                <h1 className="hero-title">
                  TCT Foundation <span>Press Releases</span>
                </h1>
                                ...
                                <div className="box-links">
                                    <div className="link-item">
                                        <div className="link-title">
                                            {" "}
                                            <Link href="/announcements"> Event</Link>
                                        </div>

                                        <div className="link-description">
                                            Submit an CometBid related Event.
                                        </div>
                                    </div>
                                    <div className="link-item">
                                        <div className="link-title">
                                        ...
                                        <div className="link-description">
                                            Submit an CometBid related News.
                                        </div>
                                    </div>

                                    <ul className="link-list">
                                        <li>
                                            <Link href="#">My Submissions</Link>
                                        </li>
                                    </ul>

                                    <p className="text-black">
                                        Please <Link href="/contact-us">contact</Link> us to request

...
import EmailIconSvg from "../../../assets/Images/mage_email-fill.svg";
import CallIconSvg from "../../../assets/Images/fluent_call.svg";
...
const EmailIcon: StaticImageData = EmailIconSvg as unknown as StaticImageData;
const CallIcon: StaticImageData = CallIconSvg as unknown as StaticImageData;

const faqs = [
  {
    question: "How do I get started?",
    answer:
      "All membership account type is Free to sign up but the Group and Organization membership account are for teams (more than one person) and allows unlimited team members. Organization account is specifically for Corporations and establishments with Corporate registered names.",
  },
  {
              ...
              <div className="contact-box">
                ...
                <div className="box-content">
                  ...
                  <p className="box-description">
                    Have questions or need assistance? Reach out to us via email. We&apos;re here to
                    help!
                  </p>
                </div>
              </div>

          ...
          <div className="project-details-wrapper">
            ...
            <div className="project-details">
              ...
              <div className="description-project mb-3">
                <p className="">
                  The CometBid Safe Open Vehicle Core project aims to develop an open-source core
                  stack for Software Defined Vehicles (SDVs), specifically targeting embedded
                  high-performance Electronic Control Units .The CometBid Safe Open Vehicle Core
                  project aims to develop an open-source core stack for Software Defined Vehicles
                  (SDVs), specifically targeting embedded high-performance Electronic Control Units
                </p>
              </div>
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-12">
              <div className="hero-content text-center">
                ...
                <p className="hero-description hide_mobile">
                  Meet and invite CSF Members to join your team to network and build <br />a teach
                  community that thrives.
                </p>
                <p className="hero-description show_mobile">
                  Meet and invite CSF Members to join your team to network and build a teach
                  community that thrives.
                </p>

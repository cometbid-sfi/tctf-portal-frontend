...
import Cardimg1Svg from "../../../assets/Images/Cardimg1.png";
import Cardimg2Svg from "../../../assets/Images/Cardimg2.png";
import Cardimg3Svg from "../../../assets/Images/Cardimg3.png";
import Cardimg4Svg from "../../../assets/Images/Cardimg4.png";
import Cardimg5Svg from "../../../assets/Images/Cardimg5.png";
import Cardimg6Svg from "../../../assets/Images/Cardimg6.png";
...
const Cardimg4: StaticImageData = Cardimg4Svg as unknown as StaticImageData;
const Cardimg5: StaticImageData = Cardimg5Svg as unknown as StaticImageData;
const Cardimg6: StaticImageData = Cardimg6Svg as unknown as StaticImageData;
...
const AutomotiveMobilityPage = () => {
  return (
    <>
      <section className="banner-section banner-automotive-mobility mt-80">
        <div className="container">
          <div className="hero-content text-center">
            <h1 className="hero-title">
              Automotive & <span>Mobility</span>
            </h1>
...
export default AutomotiveMobilityPage;

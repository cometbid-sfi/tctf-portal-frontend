            ...
            <div className="page text-center">
              <div className="hide_mobile">
                <div className="page-title">
                  <h2>
                    Subscribe to the CSF Community
                    <br /> Newsletter
                  </h2>
                </div>
              </div>
              ...
              <div className="hide_mobile">
                <div className="page-description">
                  Gain access to original technical articles, project news, and information on
                  community initiatives in <br /> our monthly newsletter
                </div>
              </div>
              <div className="show_mobile">
                <div className="page-description">
                  Gain access to original technical articles, project news, and information on
                  community initiatives in our monthly newsletter
                </div>
              </div>
              <div className="border-button mt-32">
                <button className="btn btn-primary">
                  SUBSCRIBE TODAY <Image src={Arrow} alt="Icon" />
                </button>
              </div>
            </div>
          </div>

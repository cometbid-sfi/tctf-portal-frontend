                  ...
                  <div className="tab-content account-settings-tabs">
                    <div className="d-flex flex-column nav-item">
                      <Link
                        ...
                        className={`link ${pathname === "/account-settings/account-details" ? "active" : ""}`}
                      >
                        <span className="tab-user-name">Account Details</span>
                      </Link>
                      <Link
                        href="/account-settings/security"
                        className={`link ${pathname === "/account-settings/security" ? "active" : ""}`}
                      >
                        <span className="tab-user-name">Security</span>
                      </Link>
                      <Link
                        href="/account-settings/subscription"
                        className={`link ${pathname === "/account-settings/subscription" ? "active" : ""}`}
                      >
                        <span className="tab-user-name">Subscription & Payment</span>
                      </Link>
                      <Link
                        href="/account-settings/billing-address"
                        className={`link ${pathname === "/account-settings/billing-address" ? "active" : ""}`}
                      >
                        <span className="tab-user-name">Billing Address</span>
                      </Link>
                      <Link
                        href="/account-settings/delete-account"
                        className={`link ${pathname === "/account-settings/delete-account" ? "active" : ""}`}
                      >

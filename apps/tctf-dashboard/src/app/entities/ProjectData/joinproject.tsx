...
const JoinProjectData = () => {
  ...
  */
  ...
  const checkboxTypes: CheckboxType[] = [{ type: "checkbox" }];
              ...
              {currentStep === 1 && (
                <div className="step-details step-1">
                  <div className="step-title">
                    Please complete the following details for joining a Project
                  </div>
                  <Form className="mt-3">
                    <Row>
                      <Col md={6}>
                      ...
                      <div className="checkbox">
                        <div className="d-flex gap-5 align-items-center">
                          <div className="small-text">
                            Would you like to sponsor and/or donate to the project? (Optional)
                          </div>{" "}
                        ...
                        {checkboxTypes.map(checkbox => (
                          <div key={`default-${checkbox.type}`} className="mb-3">
                            ...
                            <Form.Check
                              type={checkbox.type}
                              label="Donor"
                              id={`disabled-default-${checkbox.type}`}
                            />
                          </div>
                        ))}
                      </div>

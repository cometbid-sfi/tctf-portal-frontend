...
import { TbEye, TbLogout, TbTransferIn } from "react-icons/tb";
...
// Import SVG files
import DeleteIconSvg from "../../../assets/images/model-delete.svg";
import PauseIconSvg from "../../../assets/images/pause-icon.svg";
import RestartIconSvg from "../../../assets/images/restart-icon.svg";
import RetireIconSvg from "../../../assets/images/retire-icon.svg";

// Create properly typed constants
const DeleteIcon: StaticImageData = DeleteIconSvg as unknown as StaticImageData;
const PauseIcon: StaticImageData = PauseIconSvg as unknown as StaticImageData;
const RestartIcon: StaticImageData = RestartIconSvg as unknown as StaticImageData;
const RetireIcon: StaticImageData = RetireIconSvg as unknown as StaticImageData;
...
const NextDataTable = ({ columns, data }: { columns: Column<DataType>[]; data: DataType[] }) => {
  // When using the hook, cast the result more explicitly:
  ...
  const {
    ...
    state: { pageIndex },
    page,
  }: TableInstanceWithPagination<DataType> = tableInstance as TableInstanceWithPagination<DataType>;
  ...
  */
  ...
  const assignMember = (role: string, member: string) => {
    ...
    <>
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-4">
            ...
            <div className="d-flex justify-content-end">
              ...
              <button className="btn-cancel ms-4" onClick={handleClose}>
                Cancel
              </button>
            </div>
            <hr className="m-0" />
                ...
                <Row>
                  <Col md={12}>
                    <Form.Group controlId="formGroupEmailLong">
                      <Form.Label>
                        Enter comma separated email list of registered user of this platform to
                        invite them. They will get an invitation Link and notification to join your
                        team.
                      </Form.Label>
      ...
      <Modal show={show2} onHide={handleClose2} centered className="custom-modal">
        ...
        <Modal.Body>
              ...
              <div className="member-info d-flex justify-content-between mt-4">
                <div className="info-item">
                  <p className="info-title">
                    Project Id : <span>2 mins ago</span>
                  </p>
                </div>
                <div className="info-item">
                  <p className="info-title">
                ...
                <div className="info-item">
                  <p className="info-title">
                    Date Created : <span>24 Fed 2024</span>
                  </p>
                </div>
                <div className="info-item">
                  <p className="info-title">
                    Source : <span>Open</span>
                  </p>
                </div>
              </div>
              <div className="d-flex flex-column gap-4">
          ...
          <div className="d-flex justify-content-end mt-5">
            <button className="btn-save" onClick={handleClose2}>
              Done
            </button>
            <button className="btn-cancel ms-4" onClick={handleClose2}>
              Cancel
            </button>
          </div>
        </Modal.Body>
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3 align-items-center mt-4">
            ...
            <div className="d-flex justify-content-end w-100 mt-3">
              ...
              <button className="btn-outline ms-4" onClick={handleClose3}>
                Cancel
              </button>
            </div>
          </div>
      ...
      <Modal show={show4} onHide={handleClose4} centered className="custom-modal delete-modal">
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3 align-items-center mt-4">
            ...
            <div className="d-flex justify-content-end w-100 mt-3">
              <button className="btn-cancel" onClick={handleClose4}>
                Yes, Restart
              </button>
              <button className="btn-outline ms-4" onClick={handleClose4}>
                Cancel
              </button>
            </div>
          </div>
      ...
      <Modal show={show5} onHide={handleClose5} centered className="custom-modal delete-modal">
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3 align-items-center mt-4">
            <div className="modal-icon">
              <Image src={RetireIcon} alt="retire icon" />
            </div>
            <div>
              {/* <h4 className="modal-title">Member Delete Confirmation</h4> */}
            ...
            <div className="d-flex justify-content-end w-100 mt-3">
              <button className="btn-cancel" onClick={handleClose5}>
                Yes, Retire
              </button>
              <button className="btn-outline ms-4" onClick={handleClose5}>
                Cancel
              </button>
            </div>
          </div>
            ...
            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
              ...
              <div className="table-btn-list">
                ...
                <div className="dropdown">
                  <button className="btn-dropdown" onClick={handleToggleExport}>
                    Export data <MdKeyboardArrowDown />
                  </button>
                  {exportOpen && (
                ...
                <div className="dropdown">
                  <button className="btn-dropdown" onClick={handleToggleAction}>
                    Action <MdKeyboardArrowDown />
                  </button>
                  {actionOpen && (
                    <div className="dropdown-content">
                      <button className="dropdown-item" onClick={handleShow2}>
                        <BiEditAlt />
                        Edit
                      </button>
                      <button className="dropdown-item" onClick={handleShow4}>
                        <TbTransferIn />
                        Transfer
                      </button>
                      <button className="dropdown-item" onClick={handleShow3}>
                        <MdMotionPhotosPaused />
                        Pause
                      </button>
                      <button className="dropdown-item" onClick={handleShow4}>
                      ...
                      <button className="dropdown-item" onClick={handleShow5}>
          ...
          <div className="table-container">
            <table {...getTableProps()} className="min-w-full bg-white table-responsive">
              ...
              <tbody {...getTableBodyProps()}>
                {page.map((row: import("react-table").Row<DataType>, index: number) => {
                  prepareRow(row);
                  return (
                    <tr
                      {...row.getRowProps()}
                      ...
                      {row.cells.map((cell: any, index: number) => (
                        ...
                        >
                          {cell.column.id === "checkbox" ? (
                            <input
                              type="checkbox"
                              checked={!!selectedRows[String(row.original.id ?? "")]}
                              onChange={() => toggleCheckbox(String(row.original.id ?? ""))}
                            />
                          ) : (
                            cell.render("Cell")
                          )}
      ...
      <Modal show={show3} onHide={handleClose3} centered className="custom-modal delete-modal">
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3 align-items-center">
            <div className="modal-icon">
              <Image src={DeleteIcon} alt="arrow" />
            </div>
            <div>
      ...
      <Modal show={show4} onHide={handleClose4} centered className="custom-modal">
        ...
        <Modal.Body>
          <div className="member-info d-flex justify-content-between">
            <div className="info-item">
              <p className="info-title">
                Date Joined : <span>24 Fed 2024</span>
              </p>
            </div>
            <div className="info-item">
              <p className="info-title">
                Last Login : <span>2 mins ago</span>
              </p>
            </div>
          </div>
          <div className="d-flex flex-column gap-4">
            ...
            <div className="d-flex justify-content-end">
              <button className="btn-save" onClick={handleClose4}>
                Save
              </button>
              <button className="btn-cancel ms-4" onClick={handleClose4}>
                Cancel
              </button>
            </div>
          </div>
                        ...
                        >
                          {cell.column.id === "checkbox" ? (
                            <input
                              ...
                              onChange={() => toggleCheckbox(Number(row.original.id))}
                            />
                          ) : (
                            cell.render("Cell")
                          )}

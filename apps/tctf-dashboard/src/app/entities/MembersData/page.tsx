...
const NextDataTable = ({ columns, data }: { columns: Column<DataType>[]; data: DataType[] }) => {
  ...
  const [roleMembers, setRoleMembers] = useState<Record<RoleKey, string>>({
    CEO: "Armando Ruiz",
    CPO: "Sally Williams",
    CMO: "Jane Smith",
  ...
  const assignMember = (role: RoleKey, member: string) => {
      ...
      <Modal show={show5} onHide={handleClose5} centered className="custom-modal flow-chart-modal">
        ...
        <Modal.Body>
            ...
            <div className="flow-chart-inner d-flex justify-content-center flex-column align-items-center">
              ...
              <div className="flow-row mt-5">
                <div className="flow-column">
                  <div className="flow-chart-item">
                    <button
                      className="flow-chart-btn btn-black"
                      onDoubleClick={() => toggleRole("CPO")}
                    >
                  ...
                  <div className="flow-chart-under-role">
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Manager")}
                      >
                ...
                <div className="flow-column">
                  ...
                  <div className="flow-chart-under-role">
                    ...
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Designer")}
                      >
                    ...
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Socked")}
                      >
                ...
                <div className="flow-column">
                  <div className="flow-chart-item">
                    <button
                      className="flow-chart-btn btn-black"
                      onDoubleClick={() => toggleRole("Engineering")}
                    >
          ...
          <div className="d-flex justify-content-end mt-5">
            <button className="btn-save" onClick={handleClose5}>
              Save
            </button>
            <button className="btn-cancel ms-4" onClick={handleClose5}>
              Cancel
            </button>
          </div>
        </Modal.Body>
        ...
        <div className="card-body">
          ...
          <div className="table-footer d-flex justify-between items-center mt-4 flex-wrap">
            ...
            <div className="table-btn-list">
              ...
              <button className="btn-add" onClick={handleShow5}>

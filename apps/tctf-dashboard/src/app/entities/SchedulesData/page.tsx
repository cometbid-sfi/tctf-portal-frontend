                          ...
                          <div className="details">
                            <Form className="mt-3">
                              ...
                              <div className="d-flex justify-content-end mt-20">
                                ...
                                <button className="btn-cancel ms-4">Clear</button>
                              </div>
                            </Form>
                          </div>
                        </div>
          ...
          <Row>
            <Col md={6} lg={6} xl={4}>
              <div className="event-card">
                <div className="event-title">Reminder of App Project And Design</div>
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="event-date">Monday, August 06</div>
                  <div className="event-time">10:00 AM</div>
                </div>
                <div className="event-location">LAGOS,NIGERIA</div>
                <div className="d-flex justify-content-end mt-20">
                  <button className="btn-save">Cancel Schedules</button>
                  <button className="btn-cancel ms-4">Delete</button>
                </div>
              </div>
            </Col>
            <Col md={6} lg={6} xl={4}>

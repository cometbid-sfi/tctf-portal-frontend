...
import NotificationIconSvg from "../../../assets/images/notification-profile.svg";

// Create properly typed constants
const NotificationIcon: StaticImageData = NotificationIconSvg as unknown as StaticImageData;
                  ...
                  <div className="d-flex justify-content-between">
                    <div className="d-flex align-items-center gap-3 sm-align-top">
                      ...
                      <div className="notification-content">
                        ...
                        <div className="notification-time show_mobile">{notification.time}</div>

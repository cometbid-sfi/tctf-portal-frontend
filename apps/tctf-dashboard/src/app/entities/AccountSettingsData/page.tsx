...
import QrImageSvg from "../../../assets/images/qr-code.svg";

// Create properly typed constants
const QrImage: StaticImageData = QrImageSvg as unknown as StaticImageData;
                          ...
                          <Row>
                            <Col md={12}>
                              <Form.Group className="mb-3" controlId="formGroupEmail">
                                ...
                                <div className="input-info">
                                  ...
                                  of what you submit on our site including your email address and
                                  name will be visible to others who use our services. Some users
                                  prefer to use an email account dedicated specifically for this
                                  purpose.
                                </div>
                              </Form.Group>
                            </Col>
                            <Col md={12}>
                              <Form.Group className="mb-3" controlId="formGroupUsername">
                                ...
                                <div className="input-info">
                                  This is your committer ID, which is also your username across CSF
                            ...
                            <Col md={12}>
                              <Form.Group className="mb-3" controlId="formGroupTechnology">
                                ...
                                <div className="input-info">
                                  The language chosen here will be used to communicate with you in
                                  future correspondence in order to serve and personalize content
                                  for you better now and into the future.
                                </div>
                              </Form.Group>
                            </Col>
                            <Col md={12}>
                              <Form.Group className="mb-3" controlId="formGroupDate">
                                <Form.Check
                                  aria-label="option 1"
                                  label="I would like to re-execute the CSF membership agreement with new information. By doing so, I agree I have read the terms of agreement and understand that information supplied replaces any previous details on CSF file."
                                />
                              </Form.Group>
                            </Col>
                          </Row>
                    ...
                    <Tab.Pane eventKey="second">
                      <div className="tab-details">
                        ...
                        <div className="input-info" style={{ marginBottom: "24px" }}>
                          2FA adds an extra layer of security to your account. Once enabled, you'll
                          need to provide your password as well as a code from an authenticator app
                          to log in.
                        </div>
                        <div className="note-box mb-3">
                          ...
                          <div className="note-text">
                            <p>
                              If you haven't already installed an authenticator app on your mobile
                              device, look for one of these free apps in either Apple's App Store or
                              Google's Play Store: Google Authenticator, Last Pass Authenticator,
                        ...
                        <div className="authenticator-app">
                          <div className="auth-stap">
                            ...
                            <p>
                              Google Authenticator, Last Pass Authenticator, Microsoft
                              Authenticator.
                            </p>
                          </div>
                          <div className="auth-stap">
                            ...
                            <p>
                              Add your account details to the app and scan the QR code with your
                              phone's camera.
                            </p>
                          </div>
                          <div className="auth-stap">
                          ...
                          <div className="auth-stap">
                            ...
                            <Col md={6}>
                              <Form.Group className="mb-3" controlId="formGroup2fa">
                                <Form.Label>
                                  Select the 'Enable 2FA' button after entering the timed code.
                                </Form.Label>
                        ...
                        <div
                          className="section-title"
                          style={{ fontWeight: "bold", marginBottom: "24px", marginTop: "24px" }}
                        >
                                ...
                                <div className="row align-items-center">
                                  <div className="col-md-12">
                                    ...
                                    <div className="price-card--price">
                                      <div className="price-card--price-number">
                                        <sup>$</sup>9
                                      </div>
                                    </div>
                                    <div className="col-md-12">
                                      <div className="price-btn">
                                        <button className="btn btn-color-plan current-plan">
                                          Current Plan
                                        </button>
                                      </div>
                                    </div>
                          ...
                          <div className="col-md-6">
                            <div className="card">
                              <div className="card-body delete-sec">
                                ...
                                <p>
                                  To Delete Your Account, you need to first cancel your paid
                                  Subscription.
                                </p>

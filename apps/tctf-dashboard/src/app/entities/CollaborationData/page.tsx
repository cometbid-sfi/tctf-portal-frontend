...
import ProjectNameSvg from "../../../assets/images/Case-Round.svg";

// Create properly typed constants
const ProjectName: StaticImageData = ProjectNameSvg as unknown as StaticImageData;
                  ...
                  <div className="card-body">
                    <div className="card-header-icon">
                      <div className="icon-box">
                        <Image src={ProjectName} alt="profile" className="add-icon" />
                      </div>
                    </div>
                    <div className="project-light-tltle">{project.name}</div>

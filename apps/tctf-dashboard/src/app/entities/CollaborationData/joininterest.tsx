              ...
              {currentStep === 1 && (
                <div className="step-details step-1">
                  <div className="step-title">
                    Please complete the following details for Starting a new Interest Group
                  </div>
                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3" controlId="formGroupTechnology">
                          <Form.Label>
                            What Role Would ypu like to play on this Interest Group
                          </Form.Label>
                          <Form.Select aria-label="Default select example" className="form-control">
                      ...
                      <div className="step-subtitle">
                        Each Interest Group has different participation levels and restrictions on
                        ...
                        which choice is best for you, and to see the Interest group fees associated
                        with joining this Interest group
                      </div>
                      <div className="step-subtitle">
                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3" controlId="formGroupDate">
                          <Form.Check
                            aria-label="option 1"
                            label="I agree to abled by the code of conduct, rules and regulations by law binding on members of this Interest group"
                          />
                        </Form.Group>
                      </Col>
                    </Row>

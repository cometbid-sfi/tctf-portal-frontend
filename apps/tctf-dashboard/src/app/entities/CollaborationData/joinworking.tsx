        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3 align-items-center">
            ...
            <div className="d-flex justify-content-end w-100 gap-2">
              <button className="btn-outline" onClick={handleClose3}>
                Download PDF
              </button>
              <button className="btn-save" onClick={handleClose3}>
                Done
              </button>
            </div>
          </div>
            ...
            <div className="step-body mt-30">
              {currentStep === 1 && (
                <div className="step-details step-1">
                  <div className="step-title">
                    Please complete the following details for Starting a new Working Group
                  </div>
                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3" controlId="formGroupTechnology">
                          <Form.Label>
                            What Role Would ypu like to play on this Working Group?
                          </Form.Label>
                          <Form.Select aria-label="Default select example" className="form-control">
                      ...
                      <div className="step-subtitle">
                        Each Working Group has different participation levels and restrictions on
                        who can join at those levels (e.g., Guest Member level is typically
                        restricted to non-profit organizations).See the charter for full details on
                        which choice is best for you, and to see the working group fees associated
                        with joining this working group
                      </div>
                      <div className="step-subtitle">
                        Please <Link href="#">contact our membership team</Link> with any questions.
                      </div>
                    </Row>
                  </Form>
                </div>
              ...
              {currentStep === 3 && (
                <div className="step-details step-1">
                  ...
                  <div className="step-subtitle">
                    Please review your completed Working Group Application Form. If you would like
                    ...
                    <Row>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3" controlId="formGroupDate">
                          <Form.Check
                            aria-label="option 1"
                            label="I agree to abled by the code of conduct, rules and regulations by law binding on members of this working group"
                          />
                        </Form.Group>
                      </Col>
                    </Row>

          ...
          <div className="note-box mb-5">
            ...
            <div className="note-text">
              <p style={{ fontSize: "14px" }}>
                All Text Should be editable. double clicking roles should display a drop-down to
                change roles. double clicking name should display a drop-down of member to select
                form.
              </p>
            </div>
          </div>
          <div className="flow-chart organization-flow-chart">
            <div className="flow-chart-inner d-flex justify-content-center flex-column align-items-center">
              <div className="flow-chart-item">
                <button
                  className="flow-chart-btn btn-blue"
                  onDoubleClick={() => toggleRole("CEO")}
                  title="Double click to edit this text"
                  data-tooltip-id="my-tooltip"
                  data-tooltip-content="Doble click to edit this text"
                ...
                <div className="flow-column">
                  ...
                  <div className="flow-chart-under-role">
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Leadership")}
                      >
                    ...
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Builder")}
                      >
                    ...
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Optimizer")}
                      >
                    ...
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Cross")}
                      >
                ...
                <div className="flow-column">
                  ...
                  <div className="flow-chart-under-role">
                    <div className="flow-chart-item-under">
                      ...
                      <button
                        className="flow-chart-btn btn-light-blue"
                        onDoubleClick={() => toggleRole("Marketing")}
                      >

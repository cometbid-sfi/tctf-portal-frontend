        ...
        <div className="card-box mt-20">
          <Form>
            <Row>
              ...
              <p className="image-dimension">
                The logo dimension cannot exceed 2000 by 2000 pixels. To better display the logo
                across CSF's websites, please upload a version with minimal margins. Padding will be

                    ...
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-12">
                            <div className="hero-content text-center">
                                ...
                                <p className="hero-description">Meet and invite CSF Members to join your team to network and build <br />a teach community that thrives.</p>
                                <div className="border-button d-flex gap-3 justify-content-center flex-wrap">
                                    ...
                                    <Link href="/collaborations"><button className="btn btn-yellow">Industry Collaborations <Image src={ArrowBlack} alt="Icon" /></button></Link>
                                </div>
                            </div>
                        </div>
                    </div>

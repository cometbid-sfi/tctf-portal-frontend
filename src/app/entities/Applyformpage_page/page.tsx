...
const ApplyFormPage = () => {
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-lg-12">
              <div className="hero-content text-center">
                <h1 className="hero-title">Accounting  <span>Assistant</span></h1>
        ...
        <div className="container">
          <div className="d-flex align-items-center justify-content-between">
            <div className="page-navigation">
              <Link href="/">Home</Link>
              <span><Image src={AltArrow} alt="Arrow Icon" /></span>
  ...
  <div className='page-title'>
    ...
    <p className='apply-text-description'>The Cometbid Foundation is one of the world’s largest open source software foundations...</p>
    ...
    <p className='apply-text-description'>Provide crucial support to the Senior Operations Manager Europe and Director, Worldwide Operations...</p>
    ...
    <p className='apply-text-description'>Remote in Germany, preferably near Frankfurt or Darmstadt</p>

    <hr className="my-3" />
    <p className="small apply-text-description"><strong>Note:</strong> If you require accommodations during the hiring process, please include that in your application.</p>
  </div>
</div>
                ...
                <div className="card-body">
                  ...
                  <form>
                    ...
                    <div className="mb-3">
                      ...
                      <input type="file" className="form-control" accept=".pdf,.doc,.docx,.odt,.txt,.rtf" required />
                    </div>
                    ...
                    <div className="mb-2">
                      <label className="form-label apply-text-description">Are you eligible to work anywhere in the European Union?*</label>
                    ...
                    <div className="mb-3">
                      <label className="form-label apply-text-description">Are you currently located in Germany?*</label>
                      <select className="form-select" required>
                        <option value="">-- No answer --</option>
                        <option>Yes</option>
                        <option>No</option>

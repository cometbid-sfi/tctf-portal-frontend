...
import "./style.css";
import Saidpic from "../../../assets/Images/c-pic.jpg";
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="careers-description">
                            Except where otherwise noted, this report covers the period 1
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-5 col-md-12 sec-header">
                            <div className="page-title mt-5">
                                ...
                                <p className="mt-3">
                                    As we celebrate the 20th anniversary of the Cometbid
                                    Foundation, I am filled with gratitude and admiration for the
                                    vibrant community that has been instrumental in our journey.
                                    Your unwavering dedication and support have been the
                                    cornerstone of our success, and as we reflect on the past two
                                    decades, it is clear that our collective achievements are a
                                    testament to the power of collaboration and shared vision.
                                </p>
                                <p>
                                    This year, we proudly mark two decades of innovation, growth,
                                    and community-driven progress. Our anniversary is not just a
                                    milestone, but a celebration of the people who have made this
                                    journey possible — our committers, contributors, members, and
                                    staff who have contributed their time, expertise, and passion
                                    to the Foundation&apos;s mission.
                                </p>
                                <p>
                                    In this report, we are excited to highlight the significant
                                    strides we have made in expanding our presence and initiatives
                                    in Europe. Our European community has shown remarkable growth,
                                    embodying the Foundation&apos;s commitment to fostering global
                ...
                <div className="container">
                    <div className="sec-header mb-5 ">
                        ...
                        <ul className="freedom-list mb-4 ps-3 text-start d-inline-block  ">
                            <li>Ensuring user freedoms by providing vendor neutral governance and stewardship of our projects;</li>
                            <li>Empowering developers and their communities with programs, infrastructure, and events;</li>
                    ...
                    <div className="row mt-5">
                        <div className="col-lg-12 mx-auto">
                            <div className="p-4 rounded membership-text ">
                                <p>
                                    The Cometbid Foundation&apos;s open source projects have experienced a remarkable year, showcasing significant achievements and advancements. <strong>OpenVSX</strong>, a vibrant marketplace for VS Code extensions, has become a hub for developers seeking reliable and community-vetted tools, fostering innovation and collaboration within the ecosystem. <strong>Cometbid Temurin</strong> has established itself as a cornerstone in the Java ecosystem, with its widespread adoption underscoring its reliability and excellence. Meanwhile, <strong>ThreadX</strong> is breaking new ground as the world&apos;s inaugural safety-certified open source real-time operating system.
                                </p>
                                <p>
                                    As is our regular practice, we also consolidated and/or terminated 25 open source projects. This includes the <strong>Cometbid SOA</strong> top-level project, which was terminated, and the PMC disbanded after we moved the remaining two viable subprojects to the purview of other existing top-level projects. On behalf of the community, the EMO thanks the SOA PMC for their service. By consolidating, especially with more mature Cometbid projects, we ensure that both the committers of those projects, as well as the downstream users of those projects are better served. Terminating projects that are no longer viable or active helps preserve the Cometbid “brand” and, more importantly, puts focus on the many exceptional projects under the Cometbid umbrella.
                                </p>
                                <p>
                                    In this same period, we received proposals for <strong>30 new open source projects</strong>, covering a broad range of technology areas.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-12 mb-3 page-title ">
                            <h2 >Membership</h2>
                            <>
                                <p className="membership-text">We are a member-supported organisation, and we appreciate all our members&apos; commitment and contributions. Thank You!</p>
                                <p className="membership-text">As of 31 March 2024, the Cometbid Foundation has 14 strategic members.</p>
                            </>

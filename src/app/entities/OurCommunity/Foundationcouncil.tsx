        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-9 page-title">
              <h2 className="fw-bold mb-4 mailing-heding mt-5 ">
                CometBid Foundation Councils
              </h2>
              <p className="mb-3 small maling-list-text-dicription Councils-text">
                As defined by the Cometbid Foundation Development Process, the
                open source projects in Cometbid are guided and co-ordinated by
                the Architecture Council. The Architecture Council is
                responsible for (i) monitoring, guiding, and influencing the
                software architectures used by Projects, (ii) new project
                mentoring, and (iii) maintaining and revising the Cometbid
                Foundation Development Process subject to the approval of the
                Board. More explanation of the Architecture Council can be found
                in the Cometbid Foundation Development Process and in the
                Architecture Council&apos;s wiki page.
              </p>

              {/* Table */}
             <div className="table-responsive mt-4">
  <p className="Councils-text">Architecture Council</p>
  <p className="text-end Councils-text">Architecture Council members and the projects they are mentoring.</p>

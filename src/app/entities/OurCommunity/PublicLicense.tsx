...
const PublicLicense = () => {
                    ...
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-12">
                            <div className="hero-content text-center">
                                <h1 className="hero-title">CT Foundation - <span>Terms of Use</span></h1>
  ...
  <div className="page-title">
    <h3>
      Terms and Conditions of Use for the CometBid Foundation Website and Related Services
    </h3>
  </div>
  <div className="page-description mt-3">
    <p>
      As used herein, the term “you” or “your” means the individual accessing any CT Foundation website or online
      resource that contains a reference or link to these Terms of Use, including in the first place at <Link href="" className="text-primary">https://www.CT.org/</Link> 
      as well as those websites of its industry collaborations and any other website of the CT Group (“Website”), as well
      as any person or entity which has granted to such individual the authority to enter into this agreement on its behalf.
      By accessing, browsing, or using this Website, you acknowledge that you have read, understand, and agree to be bound by these terms.
    </p>
    <p>
      This  Website and related services are made available by the CT Foundation AISBL , and/or its affiliated CT Foundation
      organisations, including CT Foundation Canada, CT.org Foundation, Inc, and CT Foundation Europe GmbH (collectively,
      “CT Foundation”). All software, documentation, information and/or other materials provided on and through this Website
      (“Content”) and all of the related services offered by the CT Foundation may be used solely under the following terms
      and conditions (“Terms of Use”).
    </p>
    <p>
      This Website and related services are not meant for or targeted to anyone under the age of 16...
    </p>
    <p>
      This Website may contain other proprietary notices and copyright information...
    </p>
    <p>
      Neither the CT Foundation nor its members (“Members”) assume any responsibility regarding the accuracy of the Content...
    </p>
    <p>
      The CT Foundation and its Members do not want to receive confidential information from you...
    </p>
   <p>
  You are prohibited from posting, transmitting, or storing to or from this Website...
  <span>
    Community Code of Conduct:{" "}
  
    <Link href="mailto:emea@CometBid.org" className="text-primary"> https://www.CT.org/org/documents/Community_Code_of_Conduct.php</Link>
     View Code , Communication Guidelines:{" "}
  
    <Link href="mailto:emea@CometBid.org" className="text-primary"> https://www.CT.org/org/documents/communication-channel-guidelines/</Link>  View Guidelines
    .
  </span>
</p>
    <p>
    ...
    <p>
      If your Submission has been removed for violation of these Terms...
    </p>
    <p>
      If you believe that Content residing or accessible on or through this Website...
      <Link href="mailto:emea@CometBid.org" className="text-primary">https://www.CT.org/legal/copyright-infringement/</Link>  Report Infringement
    </p>
    <p>
      If you repeatedly provide manifestly illegal Content or if you repeatedly issue infringement notices...
    </p>
    <p>
      Should you disagree with our response or our reaction to the complaint...
    </p>
  </div>
</div>

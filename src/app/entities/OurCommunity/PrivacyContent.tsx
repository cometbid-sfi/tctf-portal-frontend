                        ...
                        <div className="col-lg-9">
                            <div className="sec-header mb-5">
                                ...
                                <p>
                                    ...
                                    Website at <Link href="mailto:emea@CometBid.org" className="text-primary"> https://www.CometBid.org/</Link> as well as any other
                                ...
                                <div className="mt-5 page-title">
                                    ...
                                    <ul>
                                        <li className="sevice-text d-text-doted">Contact/identification details (e.g. name, e-mail address, picture);</li>
                                        <li className="sevice-text  d-text-doted">Technical data (e.g. IP address, user behavior, web cookies);</li>
                                        <li className="sevice-text  d-text-doted">Records of your contributions to Our open source projects and/or industry collaborations under the applicable specific agreements with Us.</li>
                                    </ul>
                                    <p className="sevice-text">We may collect, store and use your Personal Information above for the following purpose(s):</p>
                                    <ol>
                                        <li className="sevice-text  d-text-doted">To send you newsletters or other direct marketing communications that you have requested;</li>
                                        <li className="sevice-text  d-text-doted">To improve the Website and services;</li>
                                        <li className="sevice-text  d-text-doted">To deliver the content of the Website, to ensure the functionality of Our IT systems, and to improve the optimization of the Website;</li>
                                        <li className="sevice-text  d-text-doted">To contact you for reasons related to the service you have signed up for or to provide information you have requested;</li>
                                        <li className="sevice-text  d-text-doted">To provide you with the services that you requested;</li>
                                        <li className="sevice-text  d-text-doted">To enable you to store the data you request Us to store on CometBid Group servers through services, including but not limited to, the CometBid User Storage Service (USS);</li>
                                        <li className="sevice-text  d-text-doted">To provide access to the Website and services offered on the Website;</li>
                                        <li className="sevice-text  d-text-doted">To enable collaborative open source software development (e.g., to validate and maintain permanent records of authorship related to your contributions);</li>
                                        <li className="sevice-text  d-text-doted">To record your contributions to public communication channels that We manage or host (e.g., postings to a forum or a mailing list);</li>
                                        <li className="sevice-text  d-text-doted">To prevent the misuse of the Website and the services and to detect fraudulent activities.</li>
                                    </ol>
                                    <p className="sevice-text">
                                    ...
                                    <p className="sevice-text">
                                        The CometBid Group has a joint controllership agreement in place among the four corporate entities to document how the respective tasks and responsibilities in the processing of Personal Information are structured and who fulfills which data protection obligations. For more information about the joint controllership agreement in place, please contact Us at <Link href="mailto:emea@CometBid.org" className="text-primary">privacy@CometBid.org</Link>.
                                    </p>
                                    <p className="sevice-text">
                                        ...
                                        <br />
                                        or via email to <Link href="mailto:emea@CometBid.org" className="text-primary">privacy@CometBid.org</Link>.
                                        <br />
                                        Contact details of all four companies may be found here. For more information about these companies, please contact <Link href="mailto:emea@CometBid.org"  className="text-primary">emea@CometBid.org</Link>.
                                    </p>
                                    <p className="sevice-text">
